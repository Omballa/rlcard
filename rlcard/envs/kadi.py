...
from rlcard.games.kadi import Game
from rlcard.games.kadi.utils import encode_hand, encode_target
from rlcard.games.kadi.utils import ACTION_SPACE, ACTION_LIST
...
class KadiEnv(Env):
    ...
    def _extract_state(self, state):
        ...
        extracted_state['raw_legal_actions'] = [a for a in state.get('legal_actions', [])]
